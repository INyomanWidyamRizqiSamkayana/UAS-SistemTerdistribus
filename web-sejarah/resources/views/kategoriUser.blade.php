<x-user-layout>
    <div class="title_left flex justify-between mx-8 pt-4">
        <!-- Search Form -->
        <form action="{{'/kategoriUser'}}" method="GET" class="flex pb-3 place-items-center" id="kategoriForm">
            <!-- Kategori Dropdown -->
            ...
            <!-- Submit Button -->
            <button type="submit" class="bg-blue-500 text-white font-md py-1 px-4 rounded-xl hover:bg-blue-600">
                Cari
            </button>
